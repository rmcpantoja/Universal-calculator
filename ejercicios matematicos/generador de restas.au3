...
; este script deberá ser ejecutado en scite para que podamos ver los resultados impresos en la consola.
; ------------------------------
...
$sResultado = ""
; imprimimos el comienzo en la consola:
consoleWrite("Generando " &$iRestas &" restas..." &@crlf &"-------------------------" &@crlf)
...
; imprimimos la resta generada en la consola:
ConsoleWrite($sResultado &@crlf)
Next
; se acabó el bucle. Ahora imprimimos el mensaje para indicar el final.
ConsoleWrite("-------------------------" &@crlf &"¡Se han generado " &$iRestas &" restas producto de mi inteligencia, la máquina! Mucho gusto en ayudarte, realmente." &@crlf)
